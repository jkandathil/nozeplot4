...
export const GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        fundamentals: [
            ...
            '**External libraries:** open **Libraries** to add dependencies by their Arduino Library Manager name (optionally `name@version`, e.g. `ArduinoJson` or `Adafruit GFX Library@1.11.9`). They are sent to the compile server and installed before building.',
            ...
            '**Compile server contract:** `POST /compile` with `{ fqbn, sketch, files, libraries }`, returning JSON with base64 `hex` (AVR) or `bin` / `parts` (ESP). Any small arduino-cli wrapper that honors this contract works.',
        ...
        implemented: [
            ...
            'Per-project **external library** manager (name or name@version) forwarded to the compile server',
            ...
            'Upload precompiled **.hex** (AVR) or **.bin** (ESP) and flash directly; optional remote **compile server**',
        ...
        steps: [
            ...
            'Click **Select port** and choose the device. To build from source, set a **compile server URL** in Settings; otherwise **Upload** a precompiled `.hex`/`.bin`.',
            'Click **Flash** (watch the **Console**), then **Serial Monitor** for output. For an autonomous loop, enable **Auto build & flash** or click **Build ▶ Flash ▶ Observe**.',
        ],
    },
    {
        id: 'code-studio',
